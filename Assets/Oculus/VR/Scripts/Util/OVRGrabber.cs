...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected void GrabEnd()
    {
        if (m_grabbedObj != null)
        {
			...
			Vector3 linearVelocity = 2.0f * ( trackingSpace.orientation * OVRInput.GetLocalControllerVelocity(m_controller) );
			Vector3 angularVelocity =  2.0f * ( trackingSpace.orientation * OVRInput.GetLocalControllerAngularVelocity(m_controller));
